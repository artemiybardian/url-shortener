...
from shared.proto import analytics_pb2 as analytics__pb2
...
class AnalyticsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.LogClick = channel.unary_unary(
                '/analytics.AnalyticsService/LogClick',
                request_serializer=analytics__pb2.ClickEvent.SerializeToString,
                response_deserializer=analytics__pb2.LogResponse.FromString,
...
def add_AnalyticsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'LogClick': grpc.unary_unary_rpc_method_handler(
                    servicer.LogClick,
                    request_deserializer=analytics__pb2.ClickEvent.FromString,
                    response_serializer=analytics__pb2.LogResponse.SerializeToString,
            ),
    }
...
class AnalyticsService(object):
    ...
    def LogClick(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/analytics.AnalyticsService/LogClick',
            analytics__pb2.ClickEvent.SerializeToString,
            analytics__pb2.LogResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
